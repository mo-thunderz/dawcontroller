// DAW Control - client code
//
//-----------------------images used-------------------------------
const play_src = ["images/play_off.jpg", "images/play_on.jpg"];
const stop_src = ["images/stop_off.jpg", "images/stop_on.jpg"];
const rec_src = ["images/record_off.jpg", "images/record_on.jpg"];
...
//----------------------------------- useful functions ----------------------------------------------------
// function to change pic image
function SwitchPic(picID, picSRC) {
  var pic = document.getElementById(picID);
  pic.src = picSRC;
}

// function that translates a midi message with shape [byte0, byte1, byte2] to an int
function MidiToInt(message) {
  return (message[0] << 16) + (message[1] << 8) + message[2];
}

// function that translates int back to midi message with shape [byte0, byte1, byte2]
...
// function to detect whether or not host is using a mobile device (can be useful for HTML code optimization)
